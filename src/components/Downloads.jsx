  ...
  return (
    <div>
      <div className="client-image-container">
        ...
        <div className="version-text">v0.1.3</div>
      </div>

      <div className="download-btn-container">
        <Link href="/docs/Installation/windows" className="download-btn">
          <img
        ...
        <Link href="/docs/Installation/mac" className="download-btn">
          <img
        ...
        <Link href="/docs/Installation/linux" className="download-btn">
          <img
      ...
      <div className="client-image-container">
        ...
        <div className="version-text">v2.0.3</div>
      </div>
      <div className="download-btn-container">
        <Link
          href={
